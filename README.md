...
| 날짜 | 주제 | 내용 요약 | 바로가기 |
| :---: | :--- | :--- | :---: |
| 2025.11.29 | Python 기초 | Hello world, 변수, 조건문, 반복문 기초 학습 | [코드보기](./파이썬_기초_공부_기록) |
| 2025.12.01 | Procedural City | 블렌더 파이썬으로 랜덤 도시 생성 및 애니메이션 | [코드보기](./Day_2:_digital_city_(blender)) |
